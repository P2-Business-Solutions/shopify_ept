    ...
    def import_shopify_stock(self, instance, validate_inventory):
        ...
        if templates:
            ...
            for location_id in location_ids:
                ...
                if not shopify_location_warehouse:
                    message = ("System tried to find the warehouse for Shopify location %s to import stock, but it was not found.\n"
								  "Action Items:\n"
								  "- Verify the Shopify location under: Shopify → Configuration → Shopify Locations.\n"
								  " Set the appropriate import stock warehouse mapping.") % location_id.name
    ...
    def prepare_val_for_stock_inventory(self, inventory_levels, instance):
        ...
        for inventory_level in inventory_levels:
            ...
            if shopify_product:
                ...
                if product_id not in product_ids_list and product_id.type not in ['service'] and product_id.is_storable == True:
